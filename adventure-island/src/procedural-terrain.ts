...
import { mx_noise_float, color, cross, dot, float, transformNormalToView, positionLocal, sign, step, Fn, uniform, varying, vec2, vec3, Loop, WebGPURenderer, MeshStandardNodeMaterial } from 'three/tsl';
...
function init() {
    ...
    rgbeLoader.load('./src/assets/pedestrian_overpass_1k.hdr', (environmentMap) => {

...
async function init() {
  ...
  const envMap = await hdrLoader.loadAsync('./src/assets/blouberg_sunrise_2_1k.hdr');
  ...
  const shadow = new THREE.TextureLoader().load('./src/assets/ferrari_ao.png');

  loader.load('./src/assets/ferrari.glb', function (gltf) {

...
* Stella -> Photographer (Camera)
* Luna -> Chef (Pizza, Cake, Chocolate)
* Albi -> Singer (Mic)
* Lion -> Officer (Guns)
* Casey -> Inventor (Robot)
...
## Items
* Camera (Stun)
* Guitar (Melee Attack, AOE, Taunt)
* Mic (Range Attack, Make enemies slow, sleepy)
* Hacking device (Open Doors/Gates, Hack Robot, Disable Turrets, Open Crate, Disable Traps)
* 3D pen (Build, Repair)
* Baseball bat (Melee Attack)
* Choco Gun (Throw Chocolate, Pizza, Cake)

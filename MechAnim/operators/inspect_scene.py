...
VALID_BONE_TYPES = ("DEF_", "DEFIK_", "CTRL_", "POLE_", "IK_", "FK_")
    ...
    def execute(self, context: bpy.types.Context) -> set[str]:
        ...
        for arm_obj in armatures:
            ...
            for bone in arm_data.bones:
                ...
                # Check mesh match for deform bones (DEF, DEFIK)
                mesh_status = ""
                if b_type in ("DEF", "DEFIK"):
                ...
                # Check IK target matching for DEFIK bones
                ik_status = ""
                if b_type == "DEFIK":

...
class LIBRARY_OT_save(Operator):
    bl_idname = "wfc_blender_hash.library_save"
...
class LIBRARY_OT_load(Operator):
    bl_idname = "wfc_blender_hash.library_load"
...
class EXPORT_OT_gltf(Operator):
    ...
    bl_idname = "wfc_blender_hash.export_gltf"
...
class LIBRARY_OT_clear(Operator):
    bl_idname = "wfc_blender_hash.library_clear"

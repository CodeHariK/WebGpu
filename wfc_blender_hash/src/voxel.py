...
class VOXEL_OT_delete(Operator):
    bl_idname = "wfc_blender_hash.voxel_delete"
...
class VOXEL_OT_delete_all(Operator):
    bl_idname = "wfc_blender_hash.voxel_delete_all"
...
class VOXEL_OT_hover(Operator):
    bl_idname = "wfc_blender_hash.voxel_hover"
    ...
    def spawn_voxel(self, c: type.Wfc_blender_hashData, snapped_location: Vector, now: float):
...
class VOXEL_OT_toggle_object_selection(Operator):
    bl_idname = "wfc_blender_hash.voxel_toggle_object_selection"
...
class VOXEL_OT_action(Operator):
    bl_idname = "wfc_blender_hash.voxel_ot_action"

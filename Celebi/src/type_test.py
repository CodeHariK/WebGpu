...
class MY_PG_SceneProperties(PropertyGroup):
    my_bool: BoolProperty(name="Bool", description="Bool property", default=False)

    my_int: IntProperty(
        name="Int", description="Integer property", default=23, min=10, max=100
    )

    my_float: FloatProperty(
        name="Float", description="Float Property", default=23.7, min=0.01, max=30.0
    )

        ...
        <div className="dashboard-container animate-fade-in">
            <header className="dashboard-header premium-card flex-between">
                ...
                <div className="system-status-toggle" style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
                    ...
                    <Link to="/dockerfiles" className="btn-icon" title="Build and Discover Dockerfiles">
            ...
            <div className="stats-grid">
                ...
                <div className="premium-card stat-card">
                    ...
                    <div className="stat-info">
                        <h3>{containers ? containers.length : 0}</h3>
                ...
                <main className="containers-list premium-card">
                    ...
                    <div className="table-responsive">
                        <table className="container-table">
                            ...
                            <tbody>
                                {images.map((img, idx) => (
                                    <tr key={img.Name || idx} className="container-row">
                                        ...
                                        <td style={{ textAlign: "right" }}>
                                            <div className="action-buttons" style={{ justifyContent: "flex-end" }}>
                                                <button
                                                    className="btn-icon text-success"
                                                    onClick={() => setShowCreateModalForImage(img.Name || null)}
